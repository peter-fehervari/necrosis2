...
testingData4SMOTE=SMOTE(Necrosis~.,data=testingData4,perc.over = 300, perc.under = 300)
...
ctl=ctree_control(testtype = "Bonferroni",minbucket = 1, maxdepth = 2)
fa1=ctree(Necrosis~.,data=testingData4SMOTE,control=ctl)
plot(fa1)
```
